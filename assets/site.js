(function () {
  ...
  /* ----------------------------------------------------------- meeting brief copy */
  window.copyMeetingBrief = function (btn) {
    var masthead = document.querySelector(".masthead h1");
    var title = masthead ? masthead.innerText.trim() : "Operating Model";
    var unit = btn.getAttribute("data-unit") || "";
    var denom = btn.getAttribute("data-denom") || "";
    var peers = btn.getAttribute("data-peers") || "";
    var misread = btn.getAttribute("data-misread") || "";
    var text = [
      "=== 3-MINUTE EXECUTIVE BRIEF: " + title.toUpperCase() + " ===",
      "",
      "• UNIT OF WORK: " + unit,
      "• CORRECT DENOMINATOR: " + denom,
      "• VALID PEER SET: " + peers,
      "• COMMON OUTSIDER MISREAD: " + misread,
      "",
      "--- Source: Sector Intelligence (tl-intel) ---"
    ].join("\n");
    if (navigator.clipboard && navigator.clipboard.writeText) {
      navigator.clipboard.writeText(text).then(function () {
        var old = btn.innerHTML;
        btn.innerHTML = "✓ Brief Copied!";
